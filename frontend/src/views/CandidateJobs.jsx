...
// Vacancies have no location field of their own (see schema.prisma) - the
// department name is the closest "where" a candidate has to search by, so
// the second search field filters on that instead of a literal location.
...
<style>
  body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; color: #14181C; padding: 32px; max-width: 800px; margin: 0 auto; }
