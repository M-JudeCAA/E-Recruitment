...
module.exports = {
  ...
  createExamGrade: (data) => prisma.examGrade.create({ data }),
  ...
  findExamGradesForCandidate: (candidateId) => prisma.examGrade.findMany({ where: { candidateId } }),
  ...
  updateExamGrade: (id, candidateId, data) => prisma.examGrade.updateMany({ where: { id, candidateId }, data }),
  deleteExamGrade: (id, candidateId) => prisma.examGrade.deleteMany({ where: { id, candidateId } })
};
